!(function(e) {
  ...
  '+TSP': function(e, t, n) {
    e.exports = self.fetch || (self.fetch = n('Cf1v').default || n('Cf1v'))
  },
  '5+HP': function(e, t, n) {
    'use strict'
    function r(e) {
        ...
        ? ((e._handled = !0),
          i._immediateFn(function() {
            ...
            if (null !== n) {
              ...
              f(t.promise, r)
            } else (1 === e._state ? f : c)(t.promise, e._value)
          }))
        : e._deferreds.push(t)
    }
    function f(e, t) {
    ...
    ;(i.prototype.catch = function(e) {
      ...
      (i.all = function(e) {
        return new i(function(t, n) {
          ...
          for (var u = i.length, f = 0; f < i.length; f++) o(f, i[f])
        })
      }),
      (i.allSettled = p),
          ...
          new Promise(function(n, r) {
            ...
            (o.onload = function() {
              o.getAllResponseHeaders().replace(/^(.*?):[^\S\n]*([\s\S]*?)$/gm, function(e, t, n) {
                i.push((t = t.toLowerCase())), u.push([t, n]), (f[t] = f[t] ? f[t] + ',' + n : n)
              }),
                n(c())
            }),
            (o.onerror = r),
  ...
  Ve17: function(e, t, n) {
    ;(function(e) {
      e.Promise || (e.Promise = n('5+HP').default), e.fetch || (e.fetch = n('+TSP'))
    }.call(this, n('pCvA')))
  },
  pCvA: function(e) {
    var t
...
//# sourceMappingURL=polyfills.77c52.esm.js.map
